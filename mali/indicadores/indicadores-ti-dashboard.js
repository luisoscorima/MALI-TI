  ...
  const defaultProjects = [
    {
      id: 1,
      nombre: "Web MALI",
      responsable: "Proveedor externo / TI",
      observaciones: "Herencia + backlog.",
      definicion_inicial_num: 50,
      presupuesto_plan: 100,
      presupuesto_real: 120,
      plazo_plan: 3,
      plazo_real: 12,
      requisitos_comprometidos: 20,
    ...
    },
    {
      ...
      observaciones: "Mejoras continuas TI.",
      definicion_inicial_num: 100,
      presupuesto_plan: 100,
      presupuesto_real: 108,
      plazo_plan: 3,
      plazo_real: 5,
